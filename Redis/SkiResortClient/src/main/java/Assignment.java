...
public class Assignment {
    ...
    public static void main(String[] args){
        ...
        Assignment obj = new Assignment(256, 500, 20, 40, west_ec2);
        obj.runAssignment();
    }

    public Assignment(int maxNumThreads, int numSkiers, String address){
        this(maxNumThreads, numSkiers, DEFAULT_NUM_OF_RUNS, DEFAULT_NUM_OF_LIFTS, address);
    }

    public Assignment(int maxNumThreads, int numSkiers, int numRuns, int numLifts, String serverAddress) {
...
//            }
    ...
    private List<Thread> generateThreads(List<int[]> idRangeList, int numberOfRequest, int[] timeRange,
        ...
        for(int i=0; i<idRangeList.size(); i++){
            ...
            Thread phase1Thread = new Thread(new Worker(
